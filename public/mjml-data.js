...
const COMPONENTS = [
  ...
  {
    id: 'standalone-logo-left',
    name: 'Standalone Logo (Left)',
    icon: '🖼️',
    category: 'Header',
    desc: 'Left-aligned logo, nothing else',
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="24px 24px 12px">
      <mj-column>
        <mj-image src="https://img.10times.com/img/mail-10times-logo-192x40.png" alt="10times" width="120px" align="left" padding="0" />
      </mj-column>
  ...
  {
    id: 'standalone-logo-center',
    name: 'Standalone Logo (Center)',
    icon: '🖼️',
    category: 'Header',
    desc: 'Center-aligned logo, nothing else',
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="24px 24px 12px">
      <mj-column>
        <mj-image src="https://img.10times.com/img/mail-10times-logo-192x40.png" alt="10times" width="120px" align="center" padding="0" />
      </mj-column>
    </mj-section>`
  },
  {
    id: 'standalone-logo-right',
    name: 'Standalone Logo (Right)',
    icon: '🖼️',
    category: 'Header',
    desc: 'Right-aligned logo, nothing else',
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="24px 24px 12px">
      <mj-column>
        <mj-image src="https://img.10times.com/img/mail-10times-logo-192x40.png" alt="10times" width="120px" align="right" padding="0" />
      </mj-column>
    </mj-section>`
  },
  {
    id: 'standalone-greeting-left',
    name: 'Standalone Greeting (Left)',
    icon: '📝',
    category: 'Header',
    desc: 'Left-aligned text greeting, nothing else',
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="16px 24px 12px">
      <mj-column>
        <mj-text mj-class="t-h2" align="left">Hi {{first_name}}, here's what's happening.</mj-text>
      </mj-column>
    </mj-section>`
  },
  {
    id: 'standalone-greeting-center',
    name: 'Standalone Greeting (Center)',
    icon: '📝',
    category: 'Header',
    desc: 'Center-aligned text greeting, nothing else',
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="16px 24px 12px">
      <mj-column>
        <mj-text mj-class="t-h2" align="center">Hi {{first_name}}, here's what's happening.</mj-text>
      </mj-column>
    </mj-section>`
  },
  {
    id: 'standalone-greeting-right',
    name: 'Standalone Greeting (Right)',
    icon: '📝',
    category: 'Header',
    desc: 'Right-aligned text greeting, nothing else',
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="16px 24px 12px">
      <mj-column>
        <mj-text mj-class="t-h2" align="right">Hi {{first_name}}, here's what's happening.</mj-text>
      </mj-column>
    </mj-section>`
  },
  {
  ...
  },
  {
    ...
    icon: "📐",
    category: "Events",
    desc: "Numbered card with aligned icon rows",
    mjml: `    <mj-wrapper background-color="%%SURFACE%%" border="1px solid %%BORDER%%" padding="0">
      <mj-section background-color="%%SURFACE%%" padding="16px 20px 0 20px">
        <mj-column>
          <mj-text mj-class="t-h2" color="%%BRAND%%"><span style="display:inline-block;width:24px;height:24px;line-height:24px;text-align:center;background:%%BRAND%%;color:#ffffff;border-radius:50%;font-size:13px;font-weight:700;margin-right:8px;">1</span>{{event_aligned_title}}</mj-text>
        </mj-column>
      </mj-section>
  ...
  {
    id: "event-aligned-2up",
    name: "Event Cards: 2-up Numbered",
    icon: "📐📐",
    category: "Events",
    desc: "Numbered event cards, 2 per row on desktop",
    repeatable: {
      perRow: 2,
      baseCount: 4,
      sectionAttrs: 'background-color="%%BG%%" padding="6px 18px 10px"',
      gapColumn: '<mj-column width="4%"><mj-spacer height="1px" /></mj-column>',
      itemFn: i => `
      <mj-column width="48%" padding="8px 0" background-color="%%SURFACE%%" border="1px solid %%BORDER%%" border-radius="10px">
        <mj-text mj-class="t-h2" color="%%BRAND%%" padding="16px 16px 0"><span style="display:inline-block;width:22px;height:22px;line-height:22px;text-align:center;background:%%BRAND%%;color:#ffffff;border-radius:50%;font-size:12px;font-weight:700;margin-right:8px;vertical-align:middle;">${i}</span><span style="vertical-align:middle;">{{evn${i}_title}}</span></mj-text>
        <mj-text mj-class="t-muted" padding="8px 16px 0"><table cellpadding="0" cellspacing="0" border="0" style="display:inline-table;vertical-align:middle;"><tr><td style="width:24px;vertical-align:top;padding:0;">🗓</td><td style="vertical-align:top;padding:0;">{{evn${i}_dates}}</td></tr></table></mj-text>
        <mj-text mj-class="t-muted" padding="2px 16px 0"><table cellpadding="0" cellspacing="0" border="0" style="display:inline-table;vertical-align:middle;"><tr><td style="width:24px;vertical-align:top;padding:0;">📍</td><td style="vertical-align:top;padding:0;">{{evn${i}_venue}}</td></tr></table></mj-text>
        <mj-spacer height="10px" />
        <mj-button mj-class="btn-primary" href="{{evn${i}_cta_url}}" padding="0 16px 4px">Interested ✅</mj-button>
        <mj-button mj-class="btn-link" href="{{evn${i}_url}}" padding="0 16px 14px">Details →</mj-button>
      </mj-column>`
    },
    mjml: `    <mj-section background-color="%%BG%%" padding="6px 18px 10px">
      <mj-column width="48%" padding="8px 0" background-color="%%SURFACE%%" border="1px solid %%BORDER%%" border-radius="10px">
        <mj-text mj-class="t-h2" color="%%BRAND%%" padding="16px 16px 0"><span style="display:inline-block;width:22px;height:22px;line-height:22px;text-align:center;background:%%BRAND%%;color:#ffffff;border-radius:50%;font-size:12px;font-weight:700;margin-right:8px;vertical-align:middle;">1</span><span style="vertical-align:middle;">{{evn1_title}}</span></mj-text>
        <mj-text mj-class="t-muted" padding="8px 16px 0"><table cellpadding="0" cellspacing="0" border="0" style="display:inline-table;vertical-align:middle;"><tr><td style="width:24px;vertical-align:top;padding:0;">🗓</td><td style="vertical-align:top;padding:0;">{{evn1_dates}}</td></tr></table></mj-text>
        <mj-text mj-class="t-muted" padding="2px 16px 0"><table cellpadding="0" cellspacing="0" border="0" style="display:inline-table;vertical-align:middle;"><tr><td style="width:24px;vertical-align:top;padding:0;">📍</td><td style="vertical-align:top;padding:0;">{{evn1_venue}}</td></tr></table></mj-text>
        <mj-spacer height="10px" />
        <mj-button mj-class="btn-primary" href="{{evn1_cta_url}}" padding="0 16px 4px">Interested ✅</mj-button>
        <mj-button mj-class="btn-link" href="{{evn1_url}}" padding="0 16px 14px">Details →</mj-button>
      </mj-column>
      <mj-column width="4%"><mj-spacer height="1px" /></mj-column>
      <mj-column width="48%" padding="8px 0" background-color="%%SURFACE%%" border="1px solid %%BORDER%%" border-radius="10px">
        <mj-text mj-class="t-h2" color="%%BRAND%%" padding="16px 16px 0"><span style="display:inline-block;width:22px;height:22px;line-height:22px;text-align:center;background:%%BRAND%%;color:#ffffff;border-radius:50%;font-size:12px;font-weight:700;margin-right:8px;vertical-align:middle;">2</span><span style="vertical-align:middle;">{{evn2_title}}</span></mj-text>
        <mj-text mj-class="t-muted" padding="8px 16px 0"><table cellpadding="0" cellspacing="0" border="0" style="display:inline-table;vertical-align:middle;"><tr><td style="width:24px;vertical-align:top;padding:0;">🗓</td><td style="vertical-align:top;padding:0;">{{evn2_dates}}</td></tr></table></mj-text>
        <mj-text mj-class="t-muted" padding="2px 16px 0"><table cellpadding="0" cellspacing="0" border="0" style="display:inline-table;vertical-align:middle;"><tr><td style="width:24px;vertical-align:top;padding:0;">📍</td><td style="vertical-align:top;padding:0;">{{evn2_venue}}</td></tr></table></mj-text>
        <mj-spacer height="10px" />
        <mj-button mj-class="btn-primary" href="{{evn2_cta_url}}" padding="0 16px 4px">Interested ✅</mj-button>
        <mj-button mj-class="btn-link" href="{{evn2_url}}" padding="0 16px 14px">Details →</mj-button>
      </mj-column>
    </mj-section>
    <mj-section background-color="%%BG%%" padding="0 18px 10px">
      <mj-column width="48%" padding="8px 0" background-color="%%SURFACE%%" border="1px solid %%BORDER%%" border-radius="10px">
        <mj-text mj-class="t-h2" color="%%BRAND%%" padding="16px 16px 0"><span style="display:inline-block;width:22px;height:22px;line-height:22px;text-align:center;background:%%BRAND%%;color:#ffffff;border-radius:50%;font-size:12px;font-weight:700;margin-right:8px;vertical-align:middle;">3</span><span style="vertical-align:middle;">{{evn3_title}}</span></mj-text>
        <mj-text mj-class="t-muted" padding="8px 16px 0"><table cellpadding="0" cellspacing="0" border="0" style="display:inline-table;vertical-align:middle;"><tr><td style="width:24px;vertical-align:top;padding:0;">🗓</td><td style="vertical-align:top;padding:0;">{{evn3_dates}}</td></tr></table></mj-text>
        <mj-text mj-class="t-muted" padding="2px 16px 0"><table cellpadding="0" cellspacing="0" border="0" style="display:inline-table;vertical-align:middle;"><tr><td style="width:24px;vertical-align:top;padding:0;">📍</td><td style="vertical-align:top;padding:0;">{{evn3_venue}}</td></tr></table></mj-text>
        <mj-spacer height="10px" />
        <mj-button mj-class="btn-primary" href="{{evn3_cta_url}}" padding="0 16px 4px">Interested ✅</mj-button>
        <mj-button mj-class="btn-link" href="{{evn3_url}}" padding="0 16px 14px">Details →</mj-button>
      </mj-column>
      <mj-column width="4%"><mj-spacer height="1px" /></mj-column>
      <mj-column width="48%" padding="8px 0" background-color="%%SURFACE%%" border="1px solid %%BORDER%%" border-radius="10px">
        <mj-text mj-class="t-h2" color="%%BRAND%%" padding="16px 16px 0"><span style="display:inline-block;width:22px;height:22px;line-height:22px;text-align:center;background:%%BRAND%%;color:#ffffff;border-radius:50%;font-size:12px;font-weight:700;margin-right:8px;vertical-align:middle;">4</span><span style="vertical-align:middle;">{{evn4_title}}</span></mj-text>
        <mj-text mj-class="t-muted" padding="8px 16px 0"><table cellpadding="0" cellspacing="0" border="0" style="display:inline-table;vertical-align:middle;"><tr><td style="width:24px;vertical-align:top;padding:0;">🗓</td><td style="vertical-align:top;padding:0;">{{evn4_dates}}</td></tr></table></mj-text>
        <mj-text mj-class="t-muted" padding="2px 16px 0"><table cellpadding="0" cellspacing="0" border="0" style="display:inline-table;vertical-align:middle;"><tr><td style="width:24px;vertical-align:top;padding:0;">📍</td><td style="vertical-align:top;padding:0;">{{evn4_venue}}</td></tr></table></mj-text>
        <mj-spacer height="10px" />
        <mj-button mj-class="btn-primary" href="{{evn4_cta_url}}" padding="0 16px 4px">Interested ✅</mj-button>
        <mj-button mj-class="btn-link" href="{{evn4_url}}" padding="0 16px 14px">Details →</mj-button>
      </mj-column>
    </mj-section>`
  },
  {
  ...
  {
    id: "standalone-links-left",
    name: "Standalone Links (Left)",
    icon: "🔗",
    category: "Header",
    desc: "Left-aligned text links separated by bull dots",
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="10px 24px">
      <mj-column>
        <mj-text mj-class="t-h2" align="left">
          <a href="{{link1_url}}" style="color:%%LINK%%;text-decoration:none;font-size:13px;font-weight:600;">Events</a>&nbsp;&nbsp;&bull;&nbsp;&nbsp;
          <a href="{{link2_url}}" style="color:%%LINK%%;text-decoration:none;font-size:13px;font-weight:600;">Profile</a>&nbsp;&nbsp;&bull;&nbsp;&nbsp;
          <a href="{{link3_url}}" style="color:%%LINK%%;text-decoration:none;font-size:13px;font-weight:600;">Settings</a>
        </mj-text>
      </mj-column>
    </mj-section>`
  },
  {
    id: "standalone-links-center",
    name: "Standalone Links (Center)",
    icon: "🔗",
    category: "Header",
    desc: "Center-aligned text links separated by bull dots",
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="10px 24px">
      <mj-column>
        <mj-text mj-class="t-h2" align="center">
          <a href="{{link1_url}}" style="color:%%LINK%%;text-decoration:none;font-size:13px;font-weight:600;">Events</a>&nbsp;&nbsp;&bull;&nbsp;&nbsp;
          <a href="{{link2_url}}" style="color:%%LINK%%;text-decoration:none;font-size:13px;font-weight:600;">Profile</a>&nbsp;&nbsp;&bull;&nbsp;&nbsp;
          <a href="{{link3_url}}" style="color:%%LINK%%;text-decoration:none;font-size:13px;font-weight:600;">Settings</a>
        </mj-text>
  ...
  {
    id: "standalone-links-right",
    name: "Standalone Links (Right)",
    icon: "🔗",
    category: "Header",
    desc: "Right-aligned text links separated by bull dots",
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="10px 24px">
      <mj-column>
        <mj-text mj-class="t-h2" align="right">
          <a href="{{link1_url}}" style="color:%%LINK%%;text-decoration:none;font-size:13px;font-weight:600;">Events</a>&nbsp;&nbsp;&bull;&nbsp;&nbsp;
          <a href="{{link2_url}}" style="color:%%LINK%%;text-decoration:none;font-size:13px;font-weight:600;">Profile</a>&nbsp;&nbsp;&bull;&nbsp;&nbsp;
          <a href="{{link3_url}}" style="color:%%LINK%%;text-decoration:none;font-size:13px;font-weight:600;">Settings</a>
        </mj-text>
  ...
  {
    id: "standalone-text-left",
    name: "Standalone Text (Left)",
    icon: "📝",
    category: "Header",
    desc: "Left-aligned muted text with bull dots",
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="10px 24px">
      <mj-column>
        <mj-text mj-class="t-muted" align="left">{{city}} &bull; {{industry}}</mj-text>
      </mj-column>
    </mj-section>`
  },
  {
    id: "standalone-text-center",
    name: "Standalone Text (Center)",
    icon: "📝",
    category: "Header",
    desc: "Center-aligned muted text with bull dots",
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="10px 24px">
      <mj-column>
        <mj-text mj-class="t-muted" align="center">{{city}} &bull; {{industry}}</mj-text>
      </mj-column>
    </mj-section>`
  },
  {
    id: "standalone-text-right",
    name: "Standalone Text (Right)",
    icon: "📝",
    category: "Header",
    desc: "Right-aligned muted text with bull dots",
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="10px 24px">
      <mj-column>
        <mj-text mj-class="t-muted" align="right">{{city}} &bull; {{industry}}</mj-text>
      </mj-column>
    </mj-section>`
  },
  {
    id: "standalone-cta-left",
    name: "Standalone Link (Left)",
    icon: "🔗",
    category: "Header",
    desc: "Left-aligned single link",
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="10px 24px">
      <mj-column>
        <mj-text mj-class="t-h2" align="left">
          <a href="{{preferences_url}}" style="color:%%LINK%%;text-decoration:none;font-size:13px;font-weight:600;">Update preferences &rarr;</a>
        </mj-text>
      </mj-column>
    </mj-section>`
  },
  {
    id: "standalone-cta-center",
    name: "Standalone Link (Center)",
    icon: "🔗",
    category: "Header",
    desc: "Center-aligned single link",
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="10px 24px">
      <mj-column>
        <mj-text mj-class="t-h2" align="center">
          <a href="{{preferences_url}}" style="color:%%LINK%%;text-decoration:none;font-size:13px;font-weight:600;">Update preferences &rarr;</a>
  ...
  {
    id: "standalone-cta-right",
    name: "Standalone Link (Right)",
    icon: "🔗",
    category: "Header",
    desc: "Right-aligned single link",
    mjml: `    <mj-section background-color="%%SURFACE%%" padding="10px 24px">
      <mj-column>
        <mj-text mj-class="t-h2" align="right">
          <a href="{{preferences_url}}" style="color:%%LINK%%;text-decoration:none;font-size:13px;font-weight:600;">Update preferences &rarr;</a>
